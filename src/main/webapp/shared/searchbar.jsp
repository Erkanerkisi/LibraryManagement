...
<form:form action="Searchmembers" method="POST">
  <div class="list-group panel">
    ...
    <a href="#demo1" class="list-group-item list-group-item-success strong" style="background: #f7f7f7;" data-toggle="collapse" data-parent="#MainMenu"><i class="fa fa-photo"></i> Member Information <i class="fa fa-caret-down"></i></a>
    ...
    <div id="demo1">
      ...
      <a href="#" class="list-group-item"><input type="text" name ="email" class="form-control filters" placeholder="Filter Email Address">  Email Address</a>
      <a href="#" class="list-group-item"><input type="text" name ="birthday" class="form-control filters" placeholder="Filter Birthday">  dateOfBirth </a>
    </div> 
